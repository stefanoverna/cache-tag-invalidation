...
export type ArtistModelFilter = {
  ...
  familiarity?: InputMaybe<FloatFilter>;
...
export enum ArtistModelOrderBy {
  ...
  FamiliarityAsc = 'familiarity_ASC',
  FamiliarityDesc = 'familiarity_DESC',
  HotnessAsc = 'hotness_ASC',
  HotnessDesc = 'hotness_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
  NameAsc = 'name_ASC',
  NameDesc = 'name_DESC'
...
export enum CompilationModelOrderBy {
  CreatedAtAsc = '_createdAt_ASC',
  CreatedAtDesc = '_createdAt_DESC',
  FirstPublishedAtAsc = '_firstPublishedAt_ASC',
  FirstPublishedAtDesc = '_firstPublishedAt_DESC',
...
/** Record of type 💽 Compilation (compilation) */
export type CompilationRecord = RecordInterface & {
  __typename?: 'CompilationRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt?: Maybe<Scalars['DateTime']['output']>;
...
/** Record of type 💽 Compilation (compilation) */
export type CompilationRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
export type Query = {
  ...
  /** Returns meta information regarding a record collection */
  _allCompilationsMeta: CollectionMetadata;
  /** Returns meta information regarding a record collection */
  _allSongsMeta: CollectionMetadata;
  ...
  /** Returns a collection of records */
  allCompilations: Array<CompilationRecord>;
  /** Returns a collection of records */
  allSongs: Array<SongRecord>;
  /** Returns a collection of assets */
  allUploads: Array<FileField>;
  /** Returns a specific record */
  artist?: Maybe<ArtistRecord>;
  /** Returns a specific record */
  compilation?: Maybe<CompilationRecord>;
  /** Returns a specific record */
  song?: Maybe<SongRecord>;
...
/** The query root for this schema */
export type Query_AllCompilationsMetaArgs = {
...
/** The query root for this schema */
export type QueryAllCompilationsArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<CompilationModelFilter>;
  first?: InputMaybe<Scalars['IntType']['input']>;
  locale?: InputMaybe<SiteLocale>;
...
/** The query root for this schema */
export type QueryCompilationArgs = {
  fallbackLocales?: InputMaybe<Array<SiteLocale>>;
  filter?: InputMaybe<CompilationModelFilter>;
  locale?: InputMaybe<SiteLocale>;
  orderBy?: InputMaybe<Array<InputMaybe<CompilationModelOrderBy>>>;
...
export type SongModelFilter = {
  ...
  durationSecs?: InputMaybe<IntegerFilter>;
  externalId?: InputMaybe<StringFilter>;
  id?: InputMaybe<ItemIdFilter>;
  name?: InputMaybe<StringFilter>;
...
export enum SongModelOrderBy {
  ...
  UpdatedAtAsc = '_updatedAt_ASC',
  UpdatedAtDesc = '_updatedAt_DESC',
  DurationSecsAsc = 'durationSecs_ASC',
  DurationSecsDesc = 'durationSecs_DESC',
  ExternalIdAsc = 'externalId_ASC',
  ExternalIdDesc = 'externalId_DESC',
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC',
...
/** Record of type 🎵 Song (song) */
export type SongRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
